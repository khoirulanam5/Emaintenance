			...
			<div class="table-responsive">
              ...
              <th class="text-center">Status</th>
                ...
                <td>
                  ...
                  <a class="btn btn-danger btn-sm m-1 hapus" href="<?= base_url('admin/datateknisi/delete/'.$value->id_user) ?>"><i class="fas fa-trash"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/datateknisi/add') ?>" method="post" enctype="multipart/form_data">
            ...
            <div class="form-group">
                ...
                <option value="">-- Status Teknisi --</option>
